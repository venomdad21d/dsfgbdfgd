import sys
import SourceZe
from SourceZe import BOTLOG_CHATID, HEROKU_APP, PM_LOGGER_GROUP_ID
...
LOGS = logging.getLogger("SourceZe")

print(SourceZe.__copyright__)
print("Licensed under the terms of the " + SourceZe.__license__)

cmdhr = Config.COMMAND_HAND_LER

try:
    LOGS.info("جارِ بدء بوت زد إي ✓")
...
async def startup_process():
    ...
    print(
        ...
        \nللمسـاعدة تواصـل  https://t.me/Source_Ze"
    )
    print("🔱🔱🔱🔱🔱🔱🔱🔱🔱🔱🔱🔱🔱🔱🔱🔱🔱🔱🔱")
    await verifyLoggerGroup()
    await saves()
